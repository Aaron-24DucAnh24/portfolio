...
export const PersonalProjectCard = ({ name, type, techs, image, source, desc }: IPersonalProjectCard) => {
  ...
  return (
    <div
      ...
      className={`shadow-md hover:shadow-2xl rounded-lg overflow-hidden border duration-1000 relative ${isDarkTheme ? 'border-third bg-fifth' : ''}`}
    >
